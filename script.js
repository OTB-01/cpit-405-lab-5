...
// ----------------- populate the table -------------------------
document.addEventListener("DOMContentLoaded", () => { // this will make sure that the table is populated ONLY when the page loads
...
function filterByName() {
    ...
    doFilter(rows, 0, word) // column 0 is the name column
}

function filterByBroadcast() {
    let menuItem = document.getElementsByClassName("select-filter")[0]
...
// dropdown menu filter event listener
